...
export const SPRITES: SpriteDef[] = [
  ...
  {
    name: "drone",
    ...makeSheet([DRONE_A, DRONE_B], PAL),
    sliceX: 2,
    anims: { hover: { from: 0, to: 1, loop: true, speed: 10 } },
  },
  { name: "flowerbed", ...makeSprite(FLOWERBED, PAL), sliceX: 1 },
  { name: "wetgrass", ...makeSprite(WET_GRASS, PAL), sliceX: 1 },
